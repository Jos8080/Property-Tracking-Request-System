...
try:
    ...
    st.info("እባክሽ የጎግል ሺቱ ስም 'Inventory_Database' መሆኑን እና ኢሜይሉ Share መደረጉን አረጋግጪ።")
    st.stop()
